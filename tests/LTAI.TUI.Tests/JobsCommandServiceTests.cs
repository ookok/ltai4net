...
{
    [Fact]
    public async Task Execute_NullJobs_DoesNotThrow()
    {
    ...
    [Fact]
    public async Task Execute_JobsList_NoJobs_ReturnsMessage()
    {
    ...
    [Fact]
    public async Task Execute_JobsShow_Missing_DoesNotThrow()
    {
        using var bgjs = new BackgroundJobService();
        var service = new JobsCommandService(bgjs);
    ...
    [Fact]
    public async Task Execute_JobsCancel_Missing_DoesNotThrow()
    {
        using var bgjs = new BackgroundJobService();
        var service = new JobsCommandService(bgjs);
    ...
    [Fact]
    public async Task Execute_JobsWatch_DoesNotThrow()
    {
        var service = new JobsCommandService(null);
    ...
    [Fact]
    public async Task Execute_JobsUnknownSubcommand_DoesNotThrow()
    {
        var service = new JobsCommandService(null);
