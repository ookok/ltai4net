...
public sealed class ProviderRegistry : IProviderRegistry
{
    ...
    private static readonly Dictionary<string, string> BuiltInBaseUrls = new()
    {
        ...
        ["open_webui"] = "http://localhost:3000/api/v1",
    ...
    private static readonly Dictionary<string, List<string>> BuiltInCapabilities = new()
    {
        ...
        ["lmstudio"] = new() { "code", "reasoning", "privacy", "local" },
        ["vllm"] = new() { "code", "reasoning", "privacy", "local" },
        ["llamacpp"] = new() { "code", "reasoning", "privacy", "local" },
        ["open_webui"] = new() { "code", "reasoning", "privacy", "local" },
