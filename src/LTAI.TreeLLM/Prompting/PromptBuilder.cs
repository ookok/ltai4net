...
public sealed class PromptBuilder
{
        ...
        PromptBuildOptions opts)
    {
        ...
        var topTier = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
        var midTier = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
        var lowTier = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
        ...
        PromptBuildOptions opts)
    {
        ...
        var used = 0;
        var fullDocs = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
        var overflowDocs = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
    ...
    private static string FormatSource(
        LTAI.Vector.Knowledge.Models.KnowledgeSearchResult doc,
        int index,
        CitationStyle style)
    {
    ...
    private static List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult> RankAndTrimContext(
        IReadOnlyList<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult> docs,
        int maxTokens)
    {
        var sorted = docs
        ...
        var result = new List<LTAI.Vector.Knowledge.Models.KnowledgeSearchResult>();
        var tokenBudget = 0;
