...
public sealed partial class KgStore : IDisposable
{
    ...
    public KgStore(string dbPath)
    {
        ...
        _reader = new SqliteConnection($"Data Source={dbPath};Mode=ReadOnly");
        _reader.Open();
    ...
    // Maintenance, stats moved to KgStore.Maintenance.cs
    ...
    // Vector search methods moved to KgStore.Vector.cs
    ...
    // Version history, export, dispose moved to KgStore.Maintenance.cs

    // HNSW index methods (RebuildCentroidsAsync, SaveHnswSnapshot,
    // WarmupHnswAsync) moved to KgStore.Vector.cs
